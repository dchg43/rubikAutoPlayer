...
public class Transform3D implements Cloneable
{
    ...
    {
        return new double[][] {{this.m00, this.m10, this.m20, this.m30}, {this.m01, this.m11, this.m21, this.m31},
            {this.m02, this.m12, this.m22, this.m32}, {0.0d, 0.0d, 0.0d, 1.0d}};
    }
    ...
    {
        return new StringBuffer().append("{").append(this.m00).append(",").append(this.m10).append(",").append(
            this.m20).append(",").append(this.m30).append("\n").append(this.m01).append(",").append(this.m11).append(
                ",").append(this.m21).append(",").append(this.m31).append("\n").append(this.m02).append(",").append(
                    this.m12).append(",").append(this.m22).append(",").append(this.m32).append("}").toString();
    }

    public boolean isNaN()
    {
        return Double.isNaN(this.m00) || Double.isNaN(this.m10) || Double.isNaN(this.m20) || Double.isNaN(this.m30)
               || Double.isNaN(this.m01) || Double.isNaN(this.m11) || Double.isNaN(this.m21) || Double.isNaN(this.m31)
               || Double.isNaN(this.m02) || Double.isNaN(this.m12) || Double.isNaN(this.m22) || Double.isNaN(this.m32);
    }
