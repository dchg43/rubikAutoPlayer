...
public class MiniCube3DAWT extends AbstractCube3DAWT
{
    ...
    private static final double[] fArr = {-8.0d, 8.0d, 9.0d, -8.0d, -8.0d, 9.0d, 8.0d, 8.0d, 9.0d, 8.0d, -8.0d, 9.0d,
        8.0d, 8.0d, -9.0d, 8.0d, -8.0d, -9.0d, -8.0d, 8.0d, -9.0d, -8.0d, -8.0d, -9.0d, -9.0d, 8.0d, 8.0d, -9.0d, -8.0d,
        8.0d, 9.0d, 8.0d, 8.0d, 9.0d, -8.0d, 8.0d, 9.0d, 8.0d, -8.0d, 9.0d, -8.0d, -8.0d, -9.0d, 8.0d, -8.0d, -9.0d,
        -8.0d, -8.0d, -8.0d, 9.0d, 8.0d, -8.0d, -9.0d, 8.0d, 8.0d, 9.0d, 8.0d, 8.0d, -9.0d, 8.0d, 8.0d, 9.0d, -8.0d,
        8.0d, -9.0d, -8.0d, -8.0d, 9.0d, -8.0d, -8.0d, -9.0d, -8.0d};
    ...
    {
        int[][] iArr = {{16, 22, 20, 18}, {0, 2, 3, 1}, {14, 8, 9, 15}, {12, 13, 11, 10}, {17, 19, 21, 23},
            {4, 6, 7, 5}, {17, 9, 1}, {19, 3, 11}, {23, 7, 15}, {16, 0, 8}, {18, 10, 2}, {22, 14, 6}, {20, 4, 12},
            {16, 18, 2, 0}, {18, 20, 12, 10}, {20, 22, 6, 4}, {22, 16, 8, 14}, {19, 17, 1, 3}, {21, 19, 11, 13},
            {23, 21, 5, 7}, {17, 23, 15, 9}, {3, 2, 10, 11}, {0, 1, 9, 8}, {4, 5, 13, 12}, {7, 6, 14, 15}};
    ...
    {
        int[][] iArr = {{0, 2, 3, 1}, {16, 22, 20, 18}, {14, 8, 9, 15}, {12, 13, 11, 10}, {17, 19, 21, 23},
            {4, 6, 7, 5}, {17, 9, 1}, {19, 3, 11}, {16, 0, 8}, {18, 10, 2}, {22, 14, 6}, {20, 4, 12}, {16, 18, 2, 0},
            {18, 20, 12, 10}, {20, 22, 6, 4}, {22, 16, 8, 14}, {19, 17, 1, 3}, {21, 19, 11, 13}, {17, 23, 15, 9},
            {3, 2, 10, 11}, {0, 1, 9, 8}, {4, 5, 13, 12}, {7, 6, 14, 15}};
    ...
    {
        int[][] iArr = {{0, 2, 3, 1}, {16, 22, 20, 18}, {14, 8, 9, 15}, {12, 13, 11, 10}, {17, 19, 21, 23}, {17, 9, 1},
            {19, 3, 11}, {16, 0, 8}, {18, 10, 2}, {16, 18, 2, 0}, {18, 20, 12, 10}, {22, 16, 8, 14}, {19, 17, 1, 3},
            {21, 19, 11, 13}, {17, 23, 15, 9}, {3, 2, 10, 11}, {0, 1, 9, 8}};
