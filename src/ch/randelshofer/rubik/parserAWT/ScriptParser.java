...
//    private static final int ROTATION_LAST_TOKEN = 83;
                        ...
                        int reflectorPos, int conjugatorPos, int commutatorPos, boolean isSequenceSupported)
    {
        ...
        if (!(this.tokens[110].length == 0 && this.tokens[111].length == 0)
            && (this.tokens[110].length == 0 || this.tokens[111].length == 0 || this.tokens[110].length != 1
                || this.tokens[111].length != 1 || this.tokens[110][0].length() < 1 || this.tokens[110][0].length() > 2
                || this.tokens[111][0].length() < 1 || this.tokens[111][0].length() > 2))
        {
            throw new IllegalArgumentException(
                new StringBuffer().append("Illegal Comment Tokens ").append(Arrays.toString(this.tokens[110])).append(
                    " ").append(Arrays.toString(this.tokens[111])).toString());
        }
        if (this.tokens[112].length != 0
            && (this.tokens[112].length != 1 || this.tokens[112][0].length() < 1 || this.tokens[112][0].length() > 2))
        {
    ...
    public ScriptNode parse(String str)
        throws IOException
    {
        return parse(new StringReader(str), null);
    }

    public ScriptNode parse(Reader reader)
        throws IOException
    {
        return parse(reader, null);
    }

    public ScriptNode parse(Reader reader, ScriptNode scriptNode)
        throws IOException,
    ...
    private void printVerbose(StreamPosTokenizer streamPosTokenizer, String str, ScriptNode scriptNode)
        throws IOException
    {
        if (!this.DEBUG)
        {
    ...
    private ExpressionNode parseExpression(StreamPosTokenizer streamPosTokenizer, ScriptNode scriptNode)
        throws IOException,
        NumberFormatException
    {
        if (this.DEBUG)
    ...
    // TODO: 看起来不正确
    private ScriptNode parsePrefix(StreamPosTokenizer streamPosTokenizer, ScriptNode scriptNode)
        throws IOException,
        NumberFormatException
    {
        if (this.DEBUG)
    ...
    private ScriptNode parseSuffix(StreamPosTokenizer streamPosTokenizer, ScriptNode scriptNode)
        throws IOException,
        NumberFormatException
    {
        if (this.DEBUG)
    ...
    private ScriptNode parseInvertor(StreamPosTokenizer streamPosTokenizer, ScriptNode scriptNode)
        throws IOException
    {
        if (this.DEBUG)
        {
        ...
        if (streamPosTokenizer.nextToken() != StreamPosTokenizer.TT_WORD /* -3 */)
        {
            throw new ParseException("Invertor: Token missing.", streamPosTokenizer.getStartPosition(),
        ...
        if (num == null || num.intValue() != 95)
        {
            throw new ParseException(
                new StringBuffer().append("Invertor: Illegal token ").append(streamPosTokenizer.sval).toString(),
    ...
    private ScriptNode parseRepetitor(StreamPosTokenizer streamPosTokenizer, ScriptNode scriptNode)
        throws IOException,
        NumberFormatException
    {
        if (this.DEBUG)
        ...
        if (streamPosTokenizer.nextToken() != StreamPosTokenizer.TT_WORD /* -3 */)
        {
            throw new ParseException("Repetitor: Token missing.", streamPosTokenizer.getStartPosition(),
                streamPosTokenizer.getEndPosition());
        }
        Hashtable<String, Integer> hashtable = this.transformationMap;
        String greedy = parseGreedy(streamPosTokenizer.sval);
        ...
        if (streamPosTokenizer.nextToken() != StreamPosTokenizer.TT_WORD /* -3 */)
        {
            throw new ParseException("Repetitor: Repeat count missing.", streamPosTokenizer.getStartPosition(),
                streamPosTokenizer.getEndPosition());
        }
        ...
        {
            throw new ParseException(
                new StringBuffer().append("Repetitor: Invalid repeat count ").append(
                    streamPosTokenizer.sval).toString(),
                streamPosTokenizer.getStartPosition(), streamPosTokenizer.getEndPosition());
        }
        int i;
        try
        ...
        {
            throw new ParseException(
                new StringBuffer().append("Repetitor: Internal Error ").append(e.getMessage()).toString(),
                streamPosTokenizer.getStartPosition(), streamPosTokenizer.getEndPosition());
        }
        if (i < 1)
        {
            throw new ParseException(new StringBuffer().append("Repetitor: Invalid repeat count ").append(i).toString(),
                streamPosTokenizer.getStartPosition(), streamPosTokenizer.getEndPosition());
        }
    ...
    private ScriptNode parseStatement(StreamPosTokenizer streamPosTokenizer, ScriptNode scriptNode)
        throws IOException,
        NumberFormatException
    {
        if (this.DEBUG)
        ...
        if (streamPosTokenizer.nextToken() != StreamPosTokenizer.TT_WORD /* -3 */)
        {
            throw new ParseException("Statement: Token missing.", streamPosTokenizer.getStartPosition(),
                streamPosTokenizer.getEndPosition());
        }
        String greedy = parseGreedy(streamPosTokenizer.sval);
        Integer num = this.transformationMap.get(greedy);
        if (num == null)
        {
            ...
            {
                throw new ParseException(
                    new StringBuffer().append("Statement: Unknown token ").append(streamPosTokenizer.sval).toString(),
                    streamPosTokenizer.getStartPosition(), streamPosTokenizer.getEndPosition());
            }
            streamPosTokenizer.pushBack();
        ...
        if (!this.isAmbiguousSeqBeginPermBegin && iIntValue == 97)
        {
            ...
            return parseSequence(
                streamPosTokenizer, scriptNode, startPosition,
                0x1 | ((this.conjugatorPos == 2 && this.isAmbiguousSeqBeginCngrBegin) ? 2 : 0)
                                                               | ((this.commutatorPos == 2
                                                                   && this.isAmbiguousSeqBeginCmtrBegin) ? 4 : 0));
        }
        ...
        if (iIntValue != 97 && iIntValue != 100
            && ((iIntValue != 107 || this.conjugatorPos != 2) && (iIntValue != 104 || this.commutatorPos != 2)))
        {
            throw new ParseException(
                new StringBuffer().append("Statement: Illegal Token ").append(streamPosTokenizer.sval).toString(),
                streamPosTokenizer.getStartPosition(), streamPosTokenizer.getEndPosition());
        }
        ...
        {
            return parseSequence(
                streamPosTokenizer, scriptNode, startPosition3, 1
                                                                | ((this.conjugatorPos == 2
                                                                    && this.isAmbiguousSeqBeginCngrBegin) ? 2 : 0)
                                                                | ((this.commutatorPos == 2
                                                                    && this.isAmbiguousSeqBeginCmtrBegin) ? 4 : 0));
        }
    ...
    private ScriptNode parseSequence(StreamPosTokenizer paramStreamPosTokenizer, ScriptNode paramScriptNode,
        ...
        throws IOException
    {
        ...
        while (true)
        {
            ...
            if (next == StreamPosTokenizer.TT_WORD /* -3 */)
            {
                ...
                if (bool == 109 && this.conjugatorPos == 2)
                {
                    ...
                    {
                        throw new ParseException("Sequence: Illegal delimiter.",
                            paramStreamPosTokenizer.getStartPosition(), paramStreamPosTokenizer.getEndPosition());
                    }
                    ...
                    {
                        throw new ParseException("Conjugation: Delimiter must occur only once",
                            paramStreamPosTokenizer.getStartPosition(), paramStreamPosTokenizer.getEndPosition());
                    }
                    consumeGreedy(paramStreamPosTokenizer, str);
                    continue;
                ...
                if (bool == 106 && this.commutatorPos == 2)
                {
                    ...
                    {
                        throw new ParseException("Commutation: Delimiter must occur only once",
                            paramStreamPosTokenizer.getStartPosition(), paramStreamPosTokenizer.getEndPosition());
                    }
                    consumeGreedy(paramStreamPosTokenizer, str);
                    continue;
            ...
            {
                throw new ParseException("Sequence: Internal error.", paramStreamPosTokenizer.getStartPosition(),
                    paramStreamPosTokenizer.getEndPosition());
            }
        }
        ...
        switch (paramInt2)
        {
            case 1:
                if (scriptNode2 != null)
                {
                    throw new ParseException("Sequence: Illegal Sequence.", paramInt1,
                        paramStreamPosTokenizer.getEndPosition());
                }
    ...
    private ScriptNode parsePermutation(StreamPosTokenizer paramStreamPosTokenizer, ScriptNode paramScriptNode,
                                        int paramInt)
        throws IOException
    {
        if (this.DEBUG)
        ...
        while (true)
        {
            switch (paramStreamPosTokenizer.nextToken())
            {
                case StreamPosTokenizer.TT_WORD: /* -3 */
                    ...
                    continue;
                case -1:
                    throw new ParseException("Permutation: Close bracket missing.",
                        paramStreamPosTokenizer.getStartPosition(), paramStreamPosTokenizer.getEndPosition());
                default:
                    throw new ParseException("Permutation: Internal error.", paramStreamPosTokenizer.getStartPosition(),
                        paramStreamPosTokenizer.getEndPosition());
            }
            if (permutationNode.getPermItemCount() == 0)
            {
                throw new ParseException("Permutation: Illegal empty Permutation.", permutationNode.getStartPosition(),
                    permutationNode.getEndPosition());
            }
            return permutationNode;
        }
    }

    private void parsePermutationItem(StreamPosTokenizer streamPosTokenizer, PermutationNode permutationNode)
        throws IOException
    {
        if (this.DEBUG)
        {
        ...
        if (streamPosTokenizer.nextToken() != StreamPosTokenizer.TT_WORD /* -3 */)
        {
            throw new ParseException("PermutationItem: Token missing.", streamPosTokenizer.getStartPosition(),
                streamPosTokenizer.getEndPosition());
        }
        int startPosition = streamPosTokenizer.getStartPosition();
        String greedy = parseGreedy(streamPosTokenizer.sval);
        ...
        {
            throw new ParseException(
                new StringBuffer().append("PermutationItem: Illegal token ").append(streamPosTokenizer.sval).toString(),
                streamPosTokenizer.getStartPosition(), streamPosTokenizer.getEndPosition());
        }
        int iIntValue = num.intValue();
        int i;
        ...
        while (i2 < 3)
        {
            if (streamPosTokenizer.nextToken() != StreamPosTokenizer.TT_WORD /* -3 */)
            {
                throw new ParseException("PermutationItem: Face token missing.", streamPosTokenizer.getStartPosition(),
                    streamPosTokenizer.getEndPosition());
            }
            String greedy2 = parseGreedy(streamPosTokenizer.sval);
            ...
            {
                throw new ParseException(
                    new StringBuffer().append("PermutationItem: Illegal or unknown token ").append(
                        streamPosTokenizer.sval).toString(),
                    streamPosTokenizer.getStartPosition(), streamPosTokenizer.getEndPosition());
            }
            ...
            {
                throw new ParseException(
                    new StringBuffer().append("PermutationItem: Illegal token ").append(
                        streamPosTokenizer.sval).toString(),
                    streamPosTokenizer.getStartPosition(), streamPosTokenizer.getEndPosition());
            }
            if (this.DEBUG)
            {
                printVerbose(streamPosTokenizer,
                    new StringBuffer().append("permutationItem Face:").append(greedy2).toString(), permutationNode);
            }
            iArr[i2++] = iIntValue2;
            consumeGreedy(streamPosTokenizer, greedy2);
            if (streamPosTokenizer.nextToken() != StreamPosTokenizer.TT_WORD /* -3 */)
    ...
    private ScriptNode parseTwist(StreamPosTokenizer streamPosTokenizer, ScriptNode scriptNode)
        throws IOException
    {
        if (this.DEBUG)
        {
        ...
        if (streamPosTokenizer.nextToken() != StreamPosTokenizer.TT_WORD /* -3 */)
        {
            throw new ParseException("Twist: Token missing.", streamPosTokenizer.getStartPosition(),
                streamPosTokenizer.getEndPosition());
        }
        ...
        {
            throw new ParseException(
                new StringBuffer().append("Twist: Illegal token ").append(streamPosTokenizer.sval).toString(),
                streamPosTokenizer.getStartPosition(), streamPosTokenizer.getEndPosition());
        }
    ...
    private ScriptNode parseMacro(StreamPosTokenizer streamPosTokenizer, ScriptNode scriptNode)
        throws IOException
    {
        if (this.DEBUG)
        {
        ...
        switch (streamPosTokenizer.nextToken())
        {
            case StreamPosTokenizer.TT_WORD: /* -3 */
                ...
                if (obj == null)
                {
                    throw new ParseException("Macro: Unexpected or unknown Token.",
                        streamPosTokenizer.getStartPosition(),
                ...
                catch (IOException e)
                {
                    ...
                    {
                        throw new ParseException(
                            new StringBuffer().append("Macro '").append(greedy).append("': ").append(
                    ...
                    throw new ParseException(
                        new StringBuffer().append("Macro '").append(greedy).append("': ").append(e.getMessage()).append(
                            " @").append(parseException.getStartPosition()).append("..").append(
                                parseException.getEndPosition()).toString(),
                        streamPosTokenizer.getStartPosition(),
                        (streamPosTokenizer.getStartPosition() + greedy.length()) - 1);
                }
            case StreamPosTokenizer.TT_EOF: /* -1 */
                throw new ParseException("Macro: Token missing.", streamPosTokenizer.getStartPosition(),
                    streamPosTokenizer.getEndPosition());
            default:
                throw new ParseException("Macro: Internal error.", streamPosTokenizer.getStartPosition(),
                    streamPosTokenizer.getEndPosition());
        }
    }
    ...
    private String parseGreedy(String str)
    {
        return (this.transformationMap.get(str) == null && this.permutationMap.get(str) == null
                && this.macroMap.get(str) == null) ? str.length() > 1 ? parseGreedy(
                    str.substring(0, str.length() - 1)) : "\000" : str;
    }

    private String parseGreedyInt(String str)
    ...
    public static int getAngle(int i)
    {
        ...
        if ((12 <= i && i <= 23)
            || ((36 <= i && i <= 47) || ((54 <= i && i <= 59) || ((66 <= i && i <= 71) || (78 <= i && i <= 83)))))
        {
            i2 *= 2;
        }
        return i2;
