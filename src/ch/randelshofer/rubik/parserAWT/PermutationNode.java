...
public class PermutationNode extends ScriptNode {
    ...
    public void applyTo(RubiksCubeCore rubiksCubeCore) {
        ...
        while (i3 < permutationItemArr.length - 1) {
            int i4 = ((permutationItemArr[i3 + 1].orientation - permutationItemArr[i3].orientation) + edgeOrientations[permutationItemArr[i3].location]) % i2;
        ...
        for (int length = permutationItemArr.length - 1; length > 0; length--) {
            ...
            edgeOrientations[permutationItemArr[length].location] = edgeOrientations[permutationItemArr[length - 1].location];
        }
    ...
    public void applyInverseTo(RubiksCubeCore rubiksCubeCore) {
        ...
        int i4 = ((((-this.sign) + permutationItemArr[permutationItemArr.length - 1].orientation) - permutationItemArr[length].orientation)
                  + edgeOrientations[permutationItemArr[length].location]) % i2;
