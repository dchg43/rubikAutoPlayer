...
public class MacroNode extends ScriptNode
{
    ...
    public void expand(ScriptParser scriptParser)
        throws IOException,
        NumberFormatException
    {
        ...
        while (true)
        {
            ...
            if ((defaultMutableTreeNode instanceof MacroNode)
                && ((MacroNode)defaultMutableTreeNode).identifier.equals(this.identifier))
            {
